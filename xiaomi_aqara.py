...
def setup(hass, config):
    ...
    for component in ['binary_sensor', 'sensor', 'switch', 'cover',
                      'lock']:#'light' deleted by XCray
    ...
    def simulate_button_service(call):
        """Service to simulate click/double-click of the button."""
        device_id = call.data.get(ATTR_DEVICE_ID)
        gateway = call.data.get(ATTR_GW_MAC)
    ...
    hass.services.register(
        DOMAIN, 'simulate_button', simulate_button_service,
